...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!args[0]) {
            ...
            embed.setDescription(`**ALL THE COMMANDS FOR THIS BOT ${message.guild.me.displayName}\nBot's Global Prefix Is \`${PREFIX}\`\nServer Prefix Is \`${prefix}\`\n\nFor Help Related To A Particular Command Type -\n\`${prefix}help [command name | alias]\`**`)
            embed.setFooter(`${message.guild.me.displayName} | Total Commands - ${bot.commands.size - 1} | Made By Kakarot#0690`, bot.user.displayAvatarURL());
